              ...
              {USER.services.map((item) => (
                ...
                >
                  <div className="flex items-center">
                    ...
                    <h3 className="dark:text-white ml-4 text-sm font-semibold text-black lg:text-base">
                      {item.name}
                    </h3>
                  </div>
                  <div className="mt-3">
              ...
              {USER.skills.map((item) => (
                ...
                >
                  <Image
                    ...
                    height={30}
                  />
                  <h3 className="dark:text-white ml-2 text-xs font-medium light:text-black md:text-sm md:ml-3">
                    {item.name}
                  </h3>
                </div>
              ))}
